...
class TestVerifyNoMissingFiles(unittest.TestCase):
    ...
    def test_file_to_list(self):
        ...
        set_of_files = verify_no_missing_files.read_files_file(fd_temp.name, None, include_all=False, generate_file_name_only=False)
    ...
    def test_check_files_no_missing_files(self):
        ...
        verify_no_missing_files.check_files(origin_temp.name, None, destination_temp.name, None, output_file.name, False)
    ...
    def test_match_prefix_ignore(self):
        ...
        verify_no_missing_files.check_files(origin_temp.name, "ace_data/",
                                            destination_temp.name, "ace_data_end_of_leg4/",
    ...
    def test_file_not_missing_etag(self):
        ...
        verify_no_missing_files.check_files(origin_temp.name, None,
                                            destination_temp.name, None,
                                            output_file.name, False)

        self.assertEqual(self._read_file_to_list(output_file.name), [])

    def test_file_not_missing_ignore_path(self):
        origin_temp = tempfile.NamedTemporaryFile(mode="w")
        origin_temp.write("ship_data_end_of_leg4/some_path/ACE_ARENAS656_000000.ENR\t20971800\t29bcd23c0887526a71e0d36aa50f5f5b-3\n")

        destination_temp = tempfile.NamedTemporaryFile(mode="w")
        destination_temp.write("ship_data/some_other_path/file_moved/ACE_ARENAS656_000000.ENR\t20971800\tda9787e5186f8a5f7e03e4a308b2cc26")
        ...
        verify_no_missing_files.check_files(origin_temp.name, "ship_data_end_of_leg4/",
                                            destination_temp.name, "ship_data/",
